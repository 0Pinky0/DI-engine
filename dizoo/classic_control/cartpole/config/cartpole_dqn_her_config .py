...
cartpole_dqn_her_config = EasyDict(cartpole_dqn_her_config)
main_config = cartpole_dqn_her_config
cartpole_dqn_her_create_config = dict(
    # env=dict(
    #     type='wargame',
...
cartpole_dqn_her_create_config = EasyDict(cartpole_dqn_her_create_config)
create_config = cartpole_dqn_her_create_config
